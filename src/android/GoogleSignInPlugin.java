...
public class GoogleSignInPlugin extends CordovaPlugin {
    ...
    public boolean execute(String action, JSONArray args, CallbackContext callbackContext) throws JSONException {
        ...
        if (action.equals(Constants.CORDOVA_ACTION_ONE_TAP_LOGIN)) {
            ...
            return true;
        } else if (action.equals(Constants.CORDOVA_ACTION_GET_USER)) {
            this.getUser(callbackContext);
            return true;
        }
        return false;
    }
	...
	private void getUser(CallbackContext callbackContext) {
        ...
        if (user != null) {
            ...
            try {
                ...
                userInfo.put("photo_url", user.getPhotoUrl() != null ? user.getPhotoUrl().toString() : null);
                callbackContext.success(getSuccessMessageInJsonString(userInfo));
            } catch (JSONException e) {
                callbackContext.error(getErrorMessageInJsonString("JSON error while building the response"));
            }
        } else {
            callbackContext.error(getErrorMessageInJsonString("No user is currently signed in."));
        }
    }
